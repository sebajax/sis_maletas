        ...
        <div class="col-sm">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ingreso Gasto (SIMULADO)</li>
                </ol> 
            </nav>      
            
            <div class="jumbotron w-100 p-3 mx-auto">

                <legend>Ingreso Gasto (SIMULADO)</legend>
                ...
                <form>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <div class="input-group-prepend w-25">
                                <span class="input-group-text bg-primary text-white w-100" id="tipo_ingreso_addon">Tipo Gasto</span>
                            </div>                    
                            <input aria-label="tipo ingreso" aria-describedby="tipo_ingreso_addon" id="tipo_ingreso" name="tipo_ingreso" placeholder="tipo gasto" type="text" class="form-control">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex flex-row-reverse">
                            <div class="p-2"><input id="btn_insertar" name="btn_insertar" type="button" class="btn btn-outline-success" value="Ingreso Gasto (SIMULADO)" onclick="altaGastoSimulado();"></div> 
